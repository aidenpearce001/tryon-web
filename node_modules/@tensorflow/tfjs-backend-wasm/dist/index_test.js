...
describeWithFlags('wasm init', BROWSER_ENVS, () => {
    ...
    it('backend init fails when the path is invalid', async () => {
        ...
        spyOn(self, 'fetch').and.callFake((path) => {
            wasmPath = path;
    ...
    it('backend init works when the path is valid and use platform fetch', async () => {
        ...
        spyOn(util, 'fetch').and.callFake((path) => {
            wasmPath = path;
            return realFetch(path);
        });
    ...
    xit('backend init fails when the path is invalid and use platform fetch', async () => {
        const usePlatformFetch = true;
