...
exports.copyPackageToStore = function (pkg, options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 8:
                if (options.knit) {
                    fs_extra_1.default.removeSync(storePackageStoreDir);
                    ensureSymlinkSync_1 = fs_extra_1.default.ensureSymlinkSync;
                    filesToCopy.forEach(function (f) {
                        var source = path_1.join(copyFromDir, f);
                        if (fs_extra_1.default.statSync(source).isDirectory()) {
                            return;
                        }
                ...
                versionPre = options.signature && !options.knit
                    ...
                    : '';
                pkgToWrite = __assign(__assign({}, pkg), { yalcSig: signature, version: pkg.version + versionPre, devDependencies: undefined });
